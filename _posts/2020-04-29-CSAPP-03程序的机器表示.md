...
![image-20210108101827006](.//img/CSAPP-03-访问信息_16个整数寄存器.png)
...
![image-20210108103512398](.//img/CSAPP-03-访问信息_操作数格式.png)
...
![image-20210108104047426](.//img/CSAPP-03-访问信息_操作数格式_内存引用.png)
...
![image-20210108104639962](.//img/CSAPP-03-访问信息_数据传送MOV.png)

![image-20210108104738496](.//img/CSAPP-03-访问信息_数据传送MOVZ和MOVS.png)

### 压入和弹出栈数据

![image-20210108124231498](.//img/CSAPP-03-访问信息_入栈和出栈指令.png)

%rsp保存着栈顶元素的地址。

![image-20210108124829895](.//img/CSAPP-03-访问信息_栈操作说明.png)

## 算术和逻辑操作

![image-20210108125109571](.//img/CSAPP-03-算术和逻辑操作_整数算术操作.png)
...
![image-20210108130007227](.//img/CSAPP-03-算术和逻辑操作_leaq指令.png)
...
![image-20210108135249102](.//img/CSAPP-03-算术和逻辑操作_特殊的算术操作.png)
...
<img src=".//img/CSAPP-03-控制_比较和测试指令.png" alt="image-20210108152001062" style="zoom:50%;" />
...
![image-20210108152921179](.//img/CSAPP-03-控制_跳转指令.png)
...
![image-20210108154457382](.//img/CSAPP-03-控制_条件语句的编译.png)
...
![image-20210108155059038](.//img/CSAPP-03-控制_使用条件赋值的条件语句的编译.png)
...
<img src=".//img/CSAPP-03-过程_通用的栈帧结构.png" alt="image-20210109094904691" style="zoom:50%;" />
...
![image-20210109095844453](.//img/CSAPP-03-过程_传递函数参数的寄存器.png)
...
![image-20210109103549509](.//img/CSAPP-03-数组_指针运算.png)

### 嵌套的数组

<img src=".//img/CSAPP-03-数组_嵌套数组按行优先存储.png" alt="image-20210109103701422" style="zoom:50%;" />
...
<img src=".//img/CSAPP-03-对抗缓冲区溢出攻击_金丝雀值.png" alt="image-20210109165850386" style="zoom:50%;" />
...
<img src=".//img/CSAPP-03-支持变长栈帧_函数vframe的栈帧结构.png" alt="image-20210109170713368" style="zoom:50%;" />
...
![image-20210109171740411](.//img/CSAPP-03-浮点代码_媒体寄存器.png)

### 浮点传送和转换操作

![image-20210109171034101](.//img/CSAPP-03-浮点代码_浮点传送指令.png)

![image-20210109171838126](.//img/CSAPP-03-浮点代码_双操作数浮点转换指令.png)

![image-20210109171916747](.//img/CSAPP-03-浮点代码_三操作数浮点转换指令.png)

### 浮点运算操作

![image-20210109172049150](.//img/CSAPP-03-浮点代码_标量浮点算术运算.png)
